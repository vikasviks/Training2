    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOrderDetails", x => x.ProductOrderId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "SupplierProductOrderDetails",
                columns: table => new
                {
                    SupplierId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    ProductOrderDetailProductOrderId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierProductOrderDetails", x => x.SupplierId);
                    table.ForeignKey(
                        name: "FK_SupplierProductOrderDetails_ProductOrderDetails_ProductOrde~",
                        column: x => x.ProductOrderDetailProductOrderId,
                        principalTable: "ProductOrderDetails",
                        principalColumn: "ProductOrderId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierProductOrderDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplierProductOrderDetails_Suppliers_SupplierId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierProductOrderDetails_ProductId",
                table: "SupplierProductOrderDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierProductOrderDetails_ProductOrderDetailProductOrderId",
                table: "SupplierProductOrderDetails",
                column: "ProductOrderDetailProductOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierProductOrderDetails_SupplierId1",
                table: "SupplierProductOrderDetails",
                column: "SupplierId1");
