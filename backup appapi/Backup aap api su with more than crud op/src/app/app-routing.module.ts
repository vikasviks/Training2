import { ListWithMaterialComponent } from './list-with-material/list-with-material.component';
...
{
  path: 'ListWithMaterialComponent',
  component: ListWithMaterialComponent,
},
{
  path: 'Update',
