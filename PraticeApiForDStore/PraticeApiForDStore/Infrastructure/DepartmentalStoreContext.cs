...
namespace PraticeApiForDStore.Infrastructure
{
    public class DepartmentalStoreContext : DbContext
    {
        ...
        public DepartmentalStoreContext(DbContextOptions options, IConfiguration config) : base(options)
        {
            _config = config;
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
           => optionsBuilder.UseNpgsql(_config.GetConnectionString("DepartmentalStoreString"));
